...
var hashtagCharts = createAreaChart(hashtags);

/**
 * This function creates an Line Chart for the hashtags visualization. 
 * 
 * @returns Line Chart basis
 */
function createAreaChart(referencedElement) {
  // Create Line Chart basis and return it.
...
function getHashtagChartWithData(minimum = 20) {
  ...
  $.ajax({
    ...
    success: function (responseData) {
      ...
      hashtagCharts.data.labels = labels;
      hashtagCharts.data.datasets[0].data = values;
      hashtagCharts.update();
    }
  });
}
