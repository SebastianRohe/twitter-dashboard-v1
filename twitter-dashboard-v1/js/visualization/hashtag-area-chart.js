...
const hashtagChartColors = ["blue", "green", "orange", "red"];
const hashtagChartColorsLessOpacity = ["rgba(78, 115, 223, 0.1)", "rgba(28, 200, 138, 0.1)", "rgba(253, 126, 20, 0.1)", "rgba(231, 74, 59, 0.1)"]
